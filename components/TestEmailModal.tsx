  ...
  useState(() => {
    ...
    template.variables.forEach(variable => {
      ...
      if (variable === 'company_name' && projectName) {
        ...
        initialVariables[variable] = '{{otp_code}}'; // Placeholder - will be generated by backend
    ...
    try {
      ...
      if (template.triggerRoute) {
        ...
        const response = await fetch('/api/email/send', {
          ...
          body: JSON.stringify({
            to: data.email,
            triggerRoute: template.triggerRoute,
        ...
        // Send test email via API using template ID
        const response = await fetch('/api/email/send', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                ...
                {generateTriggerUrl() ? (
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded px-3 py-2 text-sm text-yellow-800">
                    ⚠️ Please fill in the email address to generate the trigger URL
                  </div>
                )}
              </div>
            )}
